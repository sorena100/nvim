    ...
    config = function()
        ...
        dap.adapters.codelldb = {
          ...
          executable = {
            ...
            command = '/home/ali/.local/share/nvim/mason/packages/codelldb/extension/adapter/codelldb',
            args = {"--port", "${port}"},
        ...
        dap.adapters.cppdbg = {
            id = 'cppdbg',
            type = 'executable',
            command = '/home/ali/.vscode/extensions/ms-vscode.cpptools-1.22.11-linux-x64/debugAdapters/bin/OpenDebugAD7',
        }
        ...
        dap.configurations.cpp = {
            ...
            {
                name = 'Attach cppdbg to gdbserver :1234',
                type = 'cppdbg',
                request = 'launch',
                MIMode = 'gdb',
